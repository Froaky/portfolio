export const translations = {
  en: {
    ...
    projects: {
      ...
      items: [
        {
          badge: ["NEXT_JS", "PRISMA", "POSTGRES"],
          title: "01. OpsFlow - Engine",
          desc: "A mission-critical operational platform for managing request lifecycles and approval chains.",
          btn: "EXEC_DEMO",
        },
        {
          badge: ["PYTHON", "ODOO"],
          title: "02. ERP Hub",
          desc: "Full customization and automation hub connecting field devices with central ERP data.",
          btn: "VIEW_DOCS →",
        },
        {
          badge: ["FLUTTER", "NODE_JS"],
          title: "03. ResManager",
          desc: "Cross-platform mobile solution for tracking equipment across multiple branches.",
          btn: "VIEW_DOCS →",
        },
      ],
    },
  ...
  es: {
    ...
    projects: {
      ...
      items: [
        {
          badge: ["NEXT_JS", "PRISMA", "POSTGRES"],
          title: "01. OpsFlow - Motor",
          desc: "Una plataforma operativa de misión crítica para gestionar ciclos de vida de solicitudes y cadenas de aprobación.",
          btn: "EJECUTAR_DEMO",
        },
        {
          badge: ["PYTHON", "ODOO"],
          title: "02. ERP Hub",
          desc: "Centro de personalización y automatización integral que conecta dispositivos de campo con el ERP central en tiempo real.",
          btn: "VER_DOCS →",
        },
        {
          badge: ["FLUTTER", "NODE_JS"],
          title: "03. ResManager",
          desc: "Solución móvil multiplataforma para el seguimiento de equipos y personal en múltiples sucursales.",
          btn: "VER_DOCS →",
        },
      ],
    },
